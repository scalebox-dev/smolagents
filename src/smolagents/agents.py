...
from .remote_executors import DockerExecutor, E2BExecutor, WasmExecutor,ScaleboxExecutor
...
class CodeAgent(MultiStepAgent):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if executor_type not in {"local", "e2b", "docker", "wasm","scalebox"}:
